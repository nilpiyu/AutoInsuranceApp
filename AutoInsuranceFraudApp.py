...
def user_input_features():
    ...
    policy_bind_date = st.sidebar.text_input("Policy Bind Date")
    ...
    policy_annual_premium =  st.sidebar.number_input('Policy Annual Premium: ')
    ...
    auto_year = st.sidebar.number_input('Auto year',format="%i")    
